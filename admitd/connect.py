"""Native cognis-connect emit for admitd — forward findings to any platform.

Maps admitd's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    admitd ... --format json | admitd-emit --to stix
    admitd-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
